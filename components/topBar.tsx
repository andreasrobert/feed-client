      ...
      >
        ...
        >
          ...
          >
            ...
            <Image
              d={props.sort === "Most Upvotes" ? "inherit" : "none"}
              src="/icon-check.svg"
              pr="24px"
              alt=""
            ></Image>
          ...
          >
            ...
            <Image
              d={props.sort === "Most Comments" ? "inherit" : "none"}
              src="/icon-check.svg"
              pr="24px"
              alt=""
            ></Image>
          ...
          >
            ...
            <Image
              d={props.sort === "Least Comments" ? "inherit" : "none"}
              src="/icon-check.svg"
              pr="24px"
              alt=""
            ></Image>
          ...
          <Flex alignItems="center" justifyContent="space-between" h="25%">
            ...
            <Image
              d={props.sort === "Newest" ? "inherit" : "none"}
              src="/icon-check.svg"
              pr="24px"
              alt=""
            ></Image>
